...
<body class="min-h-screen bg-main-light text-purple-night">
    <main class="min-h-screen flex items-center justify-center p-6">
        <div class="w-full max-w-6xl grid gap-6 lg:gap-0 lg:grid-cols-[1.4fr_1.05fr]">
            <section
                class="bg-secondary-green rounded-[28px] lg:rounded-r-none p-10 sm:p-12 flex flex-col items-center justify-center text-center text-main-dark">
                <div class="w-full max-w-md">
                    <x-logo class="mb-6 w-52" />
                    <h2 class="text-3xl font-bold tracking-wide">TATU<span class="text-purple-dim">DO</span>ESTUDADO
                    </h2>
                    <p class="mt-3 text-sm font-semibold text-main-paper">
            ...
            <section
                class="bg-main-light rounded-[28px] lg:rounded-l-none p-10 sm:p-12 shadow-[0_20px_80px_rgba(64,36,92,0.08)]">
                <div class="max-w-md ml-auto">
                    <h1 class="text-4xl sm:text-5xl font-bold tracking-tight text-purple">REGISTRAR</h1>
                    <p class="mt-2 text-sm text-purple-muted">Crie uma conta para continuar</p>
                    ...
                    <form class="mt-10 space-y-5" method="POST" action="{{ route('register.store') }}">
                        ...
                        <div>
                            ...
                            <x-input id="name" name="name" type="text" placeholder="Nome"
                                value="{{ old('name') }}" />
                        </div>
                        ...
                        <p class="text-xs text-purple-muted">
                            Tem uma conta?
                            <a href="{{ route('login') }}"
                                class="font-semibold text-purple-dark hover:text-purple-deep">Entre agora</a>
                        </p>
                    </form>
                </div>
            </section>
