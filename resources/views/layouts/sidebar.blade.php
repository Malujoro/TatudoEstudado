        ...
        <div class="min-h-screen flex">
            <aside class="w-64 bg-[#B9BBA2] text-[#1F1F1F] flex flex-col border-r border-[#9FA089]">
                ...
                <nav class="mt-8 flex-1 px-6 space-y-5">
                    <a href="#" class="flex items-center gap-3 font-rem text-[20px] font-medium leading-none text-[#1F1F1F]">
                ...
                <div class="px-6 py-5 border-t border-[#9FA089]">
                    <div class="flex items-center justify-between">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="rounded-full border border-[#7B6AA7] px-4 py-2 text-sm font-semibold text-[#7B6AA7] hover:bg-[#7B6AA7] hover:text-white transition">
                                Sair
                            </button>
                        </form>
                    </div>
